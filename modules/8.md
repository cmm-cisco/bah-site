...
<img src="/training/os_files/nopsled.png">
...
{% capture text %}
<img src="/training/os_files/stacksize.png">

<p>Values on the stack can affect the location of mybuffer. Environment
...
{% capture text %}
<img src="/training/os_files/tftpdwin_install.png">
{% endcapture %}
{% include hint.html text=text %}
...
{% capture text %}
<img src="/training/os_files/tftpdwin_run.png">
{% endcapture %}
{% include hint.html text=text %}
### Task 3
...
{% capture text %}
<img src="/training/os_files/tftpdwin_crash.png">
...
{% capture text %}
<img src="/training/os_files/tftpdwin_find.png">
{% endcapture %}
{% include hint.html text=text %}
