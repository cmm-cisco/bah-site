...
{% capture text %}
<img src="/os_files/stacksize.png">
...
{% capture text %}
<img src="/os_files/tftpdwin_install.png">
{% endcapture %}
{% include hint.html text=text %}
...
{% capture text %}
<img src="/os_files/tftpdwin_run.png">
{% endcapture %}
{% include hint.html text=text %}
### Task 3
...
{% capture text %}
<img src="/os_files/tftpdwin_crash.png">
...
{% capture text %}
<img src="/os_files/tftpdwin_find.png">
{% endcapture %}
{% include hint.html text=text %}
